...
export const useConversationStore = defineStore('conversation', () => {
  ...
  // Optimistic: the list and the header read `subject` straight away, and the
  // websocket echo confirms it. Rolls back on failure.
